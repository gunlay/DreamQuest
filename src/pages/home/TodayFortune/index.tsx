...
const TodayFortune:FC<{
  expandFortune: [boolean, React.Dispatch<React.SetStateAction<boolean>>]
}> = ({expandFortune}) => {
  ...
  const toggleFortune = () => {
    ...
    expandFortune.setIsFortuneExpanded(prev => !prev)
  };
  ...
  {!hasSelectedZodiac ? (
    ...
    <View
      className={classNames(
        ...
        expandFortune.isFortuneExpanded ? style.expanded : ''
      )}
    >
